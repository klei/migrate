...
var fileNameRegex = /^[0-9]{13}_.*\.(js|coffee)$/;
...
exports.create = function (cb) {
  var template_extension = extname(exports.templatePath());
  var name = +new Date + '_' + (this.args().join(' ').replace(/[\s\.]+/g, '_') || 'migration') + template_extension;
